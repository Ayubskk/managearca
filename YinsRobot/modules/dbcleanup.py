...
import YinsRobot.modules.sql.global_bans_sql as gban_sql
import YinsRobot.modules.sql.users_sql as user_sql
from YinsRobot import DEV_USERS, OWNER_ID, dispatcher
